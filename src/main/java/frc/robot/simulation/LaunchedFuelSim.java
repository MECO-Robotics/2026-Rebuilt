...
// import
// org.ironmaple.simulation.seasonspecific.rebuilt2026.RebuiltFuelOnField;
...
// public LaunchedFuelSim(Drive drive, IntakeSim intakeSim, PositionJoint hood,
...
// boolean inSim = Constants.currentMode == Constants.Mode.SIM &&
...
// Logger.recordOutput("FieldSimulation/LaunchDebug/HasLaunchVelocity",
// hasVelocity);
// Logger.recordOutput("FieldSimulation/LaunchDebug/CooldownReady",
// cooldownReady);
// Logger.recordOutput("FieldSimulation/LaunchDebug/StoredFuelCount",
// storedFuel);
// Logger.recordOutput("FieldSimulation/LaunchDebug/ProjectileSpeedMps",
// projectileSpeedMps);
// Logger.recordOutput("FieldSimulation/LaunchDebug/PendingBurstShots",
// pendingBurstShots);
...
// Logger.recordOutput("FieldSimulation/LaunchDebug/LaunchedFuelCount",
// launchedFuelCount);
// Logger.recordOutput("FieldSimulation/LaunchDebug/LastLaunchTimestampSec",
// nowSeconds);
// }
...
// Logger.recordOutput("FieldSimulation/SuccessfulScoreCount",
...
// return Math.abs(shooterFlywheel.getVelocity()) >=
// MapleSimConstants.MIN_FLYWHEEL_RPS_FOR_SHOT;
// }
...
// double averageDelay = MapleSimConstants.SHOT_COOLDOWN_SECONDS /
// MapleSimConstants.FUEL_PER_SHOT;
// double jitterAmplitude = averageDelay *
// MapleSimConstants.SHOT_STAGGER_RANDOMNESS_RATIO;
// double randomizedDelay = averageDelay + (Math.random() * 2.0 - 1.0) *
// jitterAmplitude;
...
// double randomizedSpeedMps =
// getRandomizedProjectileSpeedMps(projectileSpeedMps);

// SimulatedArena.getInstance()
// .addGamePieceProjectile(new
// RebuiltFuelOnFly(drive.getPose().getTranslation(),
...
// .withTargetPosition(() -> new
// Translation3d(FieldConstants.Hub.hubPosition().getX(),
...
// double jitterRadians = (Math.random() * 2.0 - 1.0) *
// MapleSimConstants.SHOT_ANGLE_RANDOMNESS_RADIANS;
// double randomizedAngleRadians = baseAngleRadians + jitterRadians;
// return MathUtil.clamp(randomizedAngleRadians,
...
// double jitterScale = 1.0 + (Math.random() * 2.0 - 1.0) *
// MapleSimConstants.SHOT_VELOCITY_RANDOMNESS_RATIO;
...
// double centeredIndex = burstIndex - (MapleSimConstants.FUEL_PER_SHOT - 1) /
// 2.0;
// double lateralOffset = centeredIndex *
// MapleSimConstants.FUEL_BURST_LATERAL_SPACING_METERS;
// return MapleSimConstants.SHOOTER_TRANSLATION_ON_ROBOT.plus(new
// Translation2d(0.0, lateralOffset));
// }
...
// .plus(new Translation2d(backDirection *
// MapleSimConstants.HUB_BACK_SPAWN_X_OFFSET_METERS, 0.0));
// }
...
// double randomizedHeadingRadians = baseHeadingRadians +
// randomHeadingOffsetRadians;
// double velocityX = MapleSimConstants.HUB_BACK_SPAWN_SPEED_MPS *
// Math.cos(randomizedHeadingRadians);
// double velocityY = MapleSimConstants.HUB_BACK_SPAWN_SPEED_MPS *
// Math.sin(randomizedHeadingRadians);
// RebuiltFuelOnField spawnedFuel = new
// RebuiltFuelOnField(getHubBackSpawnPosition());
