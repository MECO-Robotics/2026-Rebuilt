...
/** Runtime simulation integration hooks with a no-op implementation for non-sim modes. */
public interface RobotSimulation {
  ...
  static RobotSimulation create(
      Drive drive, PositionJoint intakeRack, PositionJoint hood, Flywheel shooterFlywheel) {
  ...
  class MapleRobotSimulation implements RobotSimulation {
    ...
    @Override
    public void bindCommandHooks() {
      // Hooks are bound in constructor so command factories always see non-null sim endpoints.
    }
