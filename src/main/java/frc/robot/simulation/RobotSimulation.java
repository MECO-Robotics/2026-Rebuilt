...
public interface RobotSimulation {
	...
	static RobotSimulation create(Drive drive, PositionJoint intakeRack, PositionJoint hood, Flywheel shooterFlywheel) {
	...
	class NoopRobotSimulation implements RobotSimulation {
		...
		NoopRobotSimulation(Drive drive, PositionJoint intakeRack, PositionJoint hood, Flywheel shooterFlywheel) {
			robotRemyVisualizer = new RobotRemyVisualizer(drive::getPose, hood::getPosition,
	...
	class MapleRobotSimulation implements RobotSimulation {
		...
		MapleRobotSimulation(Drive drive, PositionJoint intakeRack, PositionJoint hood, Flywheel shooterFlywheel) {
			this.drive = drive;
		...
		@Override
		public void bindCommandHooks() {
			// Hooks are bound in constructor so command factories always see non-null sim
			// endpoints.
		}
