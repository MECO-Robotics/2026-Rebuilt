...
// /**
// * Runtime simulation integration hooks with a no-op implementation for
// non-sim
// * modes.
// */
...
// org.ironmaple.simulation.seasonspecific.rebuilt2026.Arena2026Rebuilt(false));
// }
// }

// static RobotSimulation create(Drive drive, PositionJoint intakeRack,
// PositionJoint hood, Flywheel shooterFlywheel) {
// if (Constants.currentMode == Constants.Mode.SIM && drive.getSimulation() !=
// null) {
...
// NoopRobotSimulation(Drive drive, PositionJoint intakeRack, PositionJoint
// hood, Flywheel shooterFlywheel) {
// robotRemyVisualizer = new RobotRemyVisualizer(drive::getPose,
// hood::getPosition,
...
// MapleRobotSimulation(Drive drive, PositionJoint intakeRack, PositionJoint
// hood, Flywheel shooterFlywheel) {
// this.drive = drive;
// IntakeSim intakeSim = new IntakeSim(drive.getSimulation());
// launchedFuelSim = new LaunchedFuelSim(drive, intakeSim, hood,
// shooterFlywheel);
// hopper = new Hopper(intakeSim::getStoredFuelCount, intakeRack::getPosition,
// drive::getPose);
// robotRemyVisualizer = new RobotRemyVisualizer(drive::getPose,
// hood::getPosition,
// shooterFlywheel::getPosition, intakeRack::getPosition, () -> 0);
...
// @Override
// public void bindCommandHooks() {
// // Hooks are bound in constructor so command factories always see non-null
// sim
// // endpoints.
// }
...
// Pose3d[] arenaFuelPoses =
// SimulatedArena.getInstance().getGamePiecesArrayByType("Fuel");
// Pose3d[] hopperFuelPoses = hopper.getGamePiecePoses();
// Pose3d[] fuelPoses = concat(arenaFuelPoses, hopperFuelPoses);

// Set<GamePieceProjectile> projectiles =
// SimulatedArena.getInstance().gamePieceLaunched();
// Pose3d[] fuelProjectilePoses = projectiles.stream()
// .filter(projectile ->
// "Fuel".equals(projectile.getType())).map(GamePieceProjectile::getPose3d)
// .toArray(Pose3d[]::new);

// Logger.recordOutput("FieldSimulation/FuelPositions", fuelPoses);
// Logger.recordOutput("FieldSimulation/HopperFuelPositions", hopperFuelPoses);
// Logger.recordOutput("FieldSimulation/HopperFuelCount",
// hopperFuelPoses.length);
// Logger.recordOutput("FieldSimulation/SuccessfulScoreCount",
// launchedFuelSim.getSuccessfulScoreCount());
// Logger.recordOutput("FieldSimulation/FuelProjectilePositions",
// fuelProjectilePoses);
// Logger.recordOutput("FieldSimulation/FuelProjectileCount",
// fuelProjectilePoses.length);
// }
