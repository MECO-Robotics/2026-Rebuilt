...
public class DriveCharacterization {
	private static final LoggedTunableNumber FF_START_DELAY = new LoggedTunableNumber(
			"DriveCharacterization/FF_Start_Delay", 2.0); // Secs
	private static final LoggedTunableNumber FF_RAMP_RATE = new LoggedTunableNumber(
			"DriveCharacterization/FF_Ramp_Rate", 0.1); // Volts/Sec
	private static final LoggedTunableNumber WHEEL_RADIUS_MAX_VELOCITY = new LoggedTunableNumber(
			"DriveCharacterization/Wheel_Radius_Max_Velocity", 0.25); // Rad/Sec
	private static final LoggedTunableNumber WHEEL_RADIUS_RAMP_RATE = new LoggedTunableNumber(
			"DriveCharacterization/Wheel_Radius_Ramp_Rate", 0.05); // Rad/Sec^2
	...
	public static Command feedforwardCharacterization(Drive drive) {
		...
		return Commands.sequence(
				...
				}, drive).withTimeout(FF_START_DELAY.get()),
