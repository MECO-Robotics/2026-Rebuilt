...
public record ChoreoTraj(
    ...
    public static final ChoreoTraj LeftBlueBump = new ChoreoTraj(
        "LeftBlueBump",
        OptionalInt.empty(),
        2.96515,
        new Pose2d(4.12235, 7.45418, Rotation2d.fromRadians(3.14159)),
        new Pose2d(3.22069, 5.21373, Rotation2d.fromRadians(-0.71883))
    );
    ...
    public static final Map<String, ChoreoTraj> ALL_TRAJECTORIES = Map.ofEntries(
        Map.entry("LeftBlueBump", LeftBlueBump)
    );
