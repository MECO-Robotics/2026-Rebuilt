...
public class DriveConstants {
    ...
    public static final double driveMotorGearRatio = 1 / ((14.0 / 50.0) * (28.0 / 16.0) * (15.0 / 45.0)); // Mk4i L3
                                                                                                          // with 14t
                                                                                                          // pinion
    ...
    public static final DriveTrainSimulationConfig mapleSimConfig = DriveTrainSimulationConfig.Default()
            ...
            .withSwerveModule(COTS.ofSwerveXFlipped(turnGearbox, driveGearbox, wheelCOF, turnMotorCurrentLimit,
                    driveMotorCurrentLimit));
}
