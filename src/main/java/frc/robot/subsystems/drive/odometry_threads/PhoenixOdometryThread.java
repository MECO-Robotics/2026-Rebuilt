...
package frc.robot.subsystems.drive.odometry_threads;
...
public class PhoenixOdometryThread extends Thread {
	...
	// Check if either drive or azimuth are CANFD. All CTRE devices on the swerve
	// drive must be on the
	// same CAN loop.
	private static boolean isCANFD = new CANBus(DriveMotorConstants.canBusName).isNetworkFD()
