...
public class DriveMotorIOSimMaple implements DriveMotorIO {
	...
	public DriveMotorIOSimMaple(SwerveModuleSimulation moduleSimulation, String name, DriveMotorHardwareConfig config) {
		this.moduleSimulation = moduleSimulation;
		this.driveController = moduleSimulation.useGenericMotorControllerForDrive()
