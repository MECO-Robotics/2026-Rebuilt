...
public interface DriveMotorIO {
	...
	public static Supplier<DriveMotorIO> talonFXFactory(String name, DriveMotorHardwareConfig config) {
		return () -> new DriveMotorIOTalonFX(name, config);
	}

	/** Creates a SparkMax-backed drive motor IO supplier. */
	public static Supplier<DriveMotorIO> sparkMaxFactory(String name, DriveMotorHardwareConfig config) {
	 ...
	 */
	public static DriveMotorIO fromMode(String name, DriveMotorHardwareConfig config,
	 ...
	 * module IO endpoints that share state with azimuth IO).
	 */
	public static DriveMotorIO fromMode(String name, DriveMotorHardwareConfig config,
			Supplier<DriveMotorIO> realFactory, Supplier<DriveMotorIO> simFactory) {
	...
	/**
	 * Creates mode-appropriate drive motor IO using TalonFX for real hardware and a
	 * custom sim source.
	 */
	public static DriveMotorIO fromTalonFX(String name, DriveMotorHardwareConfig config,
