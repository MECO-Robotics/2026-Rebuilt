...
public interface GyroIO {
	 ...
	 *
	 * <p>
	 * Returns the supplied real implementation on real hardware, default MapleSim
	 * IO in sim, and no-op IO for replay.
	 */
	 ...
	 *
	 * <p>
	 * Allows callers to provide a custom sim factory for shared MapleSim state.
	 */
