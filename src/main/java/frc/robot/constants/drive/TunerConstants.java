...
public class TunerConstants {
	...
	private static final LoggedTunableNumber SHOOTER_SLOWDOWN_FACTOR = new LoggedTunableNumber(
			"Shooter Slowdown Factor", 0.75);
	...
	// This needs to be tuned to your individual robot
	public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(11.13);
