...
public final class DrivetrainConstants {
	...
	private static final TalonFXConfiguration STEER_INITIAL_CONFIGS = new TalonFXConfiguration().withCurrentLimits(
			new CurrentLimitsConfigs().withStatorCurrentLimit(Amps.of(20)).withStatorCurrentLimitEnable(true));
	...
	private static final Distance WHEEL_RADIUS = Inches.of(2.125);
