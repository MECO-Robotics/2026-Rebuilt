...
public class DrivetrainConstants {
	...
	public static final double MAX_SPEED = 5.57; // Meters per second
	public static final double MAX_ANGULAR_RATE = 1.5; // Rotations per second

	// The steer motor uses any SwerveModule.SteerRequestType control request with
	// the
	// output type specified by SwerveModuleConstants.SteerMotorClosedLoopOutput
	private static final Slot0Configs steerGains = new Slot0Configs().withKP(200).withKI(0).withKD(1).withKS(0.1)
			.withKV(2.0).withKA(0.01).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
	// When using closed-loop control, the drive motor uses the control
	// output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
	private static final Slot0Configs driveGains = new Slot0Configs().withKP(2.84).withKI(0).withKD(0).withKS(0.25)
