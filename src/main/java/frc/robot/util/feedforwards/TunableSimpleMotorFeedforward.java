 ...
 */
public class TunableSimpleMotorFeedforward implements ProtobufSerializable, StructSerializable {
	 ...
	 * gain is defaulted to zero. The period is defaulted to 20 ms.
	 *
	 * <p>
	 * The units should be radians for angular systems and meters for linear
	 * systems.
